...
var IGNORED_NODE = -2;
var NodeEmitter = (function () {
    function NodeEmitter() {
        this.emit = function (i, n) { return void 0; };
    }
    NodeEmitter.prototype.onNewNode = function (func) {
        this.emit = func;
    };
    return NodeEmitter;
}());
...
function serializeNodeWithId(n, doc, map, blockClass, skipChild, inlineStylesheet, maskInputOptions, slimDOMOptions, recordCanvas, preserveWhiteSpace) {
    ...
    if ((serializedNode.type === exports.NodeType.Document ||
        ...
        for (var _i = 0, _a = Array.from(n.childNodes); _i < _a.length; _i++) {
            var childN = _a[_i];
            var serializedChildNode = serializeNodeWithId(childN, doc, map, blockClass, skipChild, inlineStylesheet, maskInputOptions, slimDOMOptions, recordCanvas, preserveWhiteSpace);
...
function snapshot(n, blockClass, inlineStylesheet, maskAllInputsOrOptions, slimDOMSensibleOrOptions, recordCanvas) {
    ...
    return [
        serializeNodeWithId(n, n, idNodeMap, blockClass, false, inlineStylesheet, maskInputOptions, slimDOMOptions, recordCanvas),
        idNodeMap,
    ];
}
